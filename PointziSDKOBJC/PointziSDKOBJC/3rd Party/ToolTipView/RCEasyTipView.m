...
- (void)drawRect:(CGRect)rect {
    ...
    _bubbleRect =bubbleFrame;
    
    [self drawBubbleWithFrame:bubbleFrame arrowPosition:position andContext:context];

    self.textLabel = [[UILabel alloc] init];
    self.textLabel.numberOfLines = 0 ;
    self.textLabel.frame = CGRectMake(bubbleFrame.origin.x + 70, bubbleFrame.origin.y + 10, bubbleFrame.size.width - 70, 100);
   
    [self addSubview:self.textLabel];
    //[self drawTextWithFrame:bubbleFrame andContext:context];
    
    self.imageView =  [[UIImageView alloc] init];
    self.imageView.frame = CGRectMake(bubbleFrame.origin.x + 10, bubbleFrame.origin.y + 10, 50, 50);
...
- (void)drawTextWithFrame:(CGRect)bubbleFrame andContext:(CGContextRef)context {
    ...
    CGRect textRect = CGRectMake(bubbleFrame.origin.x + 60 + (bubbleFrame.size.width - [self getTextSize].width) / 2, bubbleFrame.origin.y + (bubbleFrame.size.height - [self getTextSize].height) / 2, [self getTextSize].width, [self getTextSize].height);
...
- (void)updateTextWithFrame {
    ...
    CGRect textRect = CGRectMake(_bubbleRect.origin.x + 60 + (_bubbleRect.size.width - [self getTextSize].width) / 2, _bubbleRect.origin.y + (_bubbleRect.size.height - [self getTextSize].height) / 2, [self getTextSize].width, [self getTextSize].height);
